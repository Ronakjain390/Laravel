<div class="rounded-lg dark:border-gray-700 mt-4  "  >
    @php
        ...
        if ($permission) {
            ...
            $additionalNumberPermission = isset($permission->sender) ? $permission->sender->whatsapp->additional_number : null;
        } else {
            ...
            <div class="items-center justify-center h-auto rounded bg-gray-50 dark:bg-gray-800">
                <div class="w-full p-2 border border-gray-200 rounded-lg shadow sm:p-4 bg-[#ebebeb] @if ($pdfData->challan_templete == 1 || $pdfData->challan_templete == 5 || $pdfData->challan_templete == 6) @if($updateForm == true) grid @endif md:grid-cols-2 @endif">
                    ...
                    <div x-data="{ addUser: false, inputsDisabled: true }">
                        <div x-data="{ search: '', selectedUser: null }" wire:ignore.self>
                            ...
                            <button id="dropdownSearchButton small_outlined" data-dropdown-toggle="dropdownSearch"
                                ...
                                class="text-black border border-gray-400 border-solid flex w-full bg-white hover:bg-orange focus:ring-2 focus:outline-none focus:ring-[#372b2b]/50 font-medium rounded-lg text-[0.6rem] sm:text-xs px-5 py-1.5 text-center items-center justify-center dark:focus:ring-gray-900 dark:hover-bg-[#050708]/30 mr-2 mb-2"
                                type="button">
                            ...
                            <div x-data="{ search: '', selectedUser: null }" id="dropdownSearch"
                                class="z-20 hidden bg-white rounded-lg shadow w-72 dark:bg-gray-700">
                                <!-- Search input -->
                                <div class="p-3">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input x-model="search" type="text" id="input-group-search"
                                            class="block w-full p-2 pl-5 text-[0.6rem] sm:text-xs text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    ...
                                    {{-- @dump($user->series_number->series_number ?? ''); --}}
                                        <li class="cursor-pointer"
                                            ...
                                            <div
                                                ...
                                                <label wire:ignore
                                                    class="w-full py-1.5 ml-2 text-[0.6rem] sm:text-xs font-medium text-gray-900 rounded cursor-pointer dark:text-gray-300">{{ $user->receiver_name ?? null }}</label>
                                            </div>
                                        </li>
                                    @endforeach
                                </ul>
                                <button wire:click="updateField"   class="flex w-full items-center p-3 text-[0.6rem] sm:text-xs font-medium text-green-600 border-t border-gray-200 rounded-b-lg bg-gray-50 dark:border-gray-600 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-green-500 hover:underline">
                            ...
                            <div class="grid grid-cols-12 gap-3" x-show="!addUser"  >
                                <div class="col-span-12 md:col-span-6">
                                    <div class="grid gap-3">
                                        <div class="flex flex-row">
                                            <dt class="mb-1 text-black text-[0.6rem] sm:text-xs font-semibold w-1/4">Phone</dt>
                                            @if ($selectedUser && $selectedUser['phone'])
                                                <dd class="pl-2 text-[0.6rem] sm:text-xs text-[#686464] text-black capitalize">
                                                    {{ $selectedUser['phone'] }}
                                                </dd>
                                            @endif
                                            <dd class="ml-auto text-[0.6rem] inline-block text-[#686464] text-black capitalize md:hidden">
                                                    ...
                                                    <div class="relative max-w-sm pl-2 text-[0.6rem]">
                                                        <div class="absolute inset-y-0 text-[0.6rem] start-0 flex items-center ps-3 pointer-events-none">
                                                            <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                                                <path d="M20 4a2 2 0 0 0-2-2h-2V1a1 1 0 0 0-2 0v1h-3V1a1 1 0 0 0-2 0v1H6V1a1 1 0 0 0-2 0v1H2a2 2 0 0 0-2 2v2h20V4ZM0 18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8H0v10Zm5-8h10a1 1 0 0 1 0 2H5a1 1 0 0 1 0-2Z"/>
                                                            </svg>
                                                        </div>
                                                        <input wire:model.defer="createChallanRequest.challan_date" id="datepicker-autohide" datepicker datepicker-autohide type="text" class="bg-gray-50 border border-gray-300 text-gray-900 h-6 text-[0.6rem] rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
                                                    </div>
                                                    @endif
                                            </dd>
                                        </div>
                                        ...
                                        <div class="flex flex-row">
                                            <dt class="mb-1 text-black text-[0.6rem] sm:text-xs font-semibold w-1/4">Email</dt>
                                            @if ($selectedUser && $selectedUser['email'])
                                                <dd class="pl-2 text-[0.6rem] sm:text-xs text-black capitalize">
                                                    {{ $selectedUser['email'] }}
                                                </dd>
                                                @endif
                                            </div>
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    <div class="grid">
                                        <div class="flex flex-row items-end items-center">
                                            <dt class="w-1/4 mb-1 text-black text-[0.6rem] sm:text-xs font-semibold whitespace-nowrap">
                                                Series No.
                                            </dt>
                                            @if ($selectedUser != null)
                                                <dd class="pl-2 text-[0.6rem] sm:text-xs capitalize flex whitespace-nowrap items-center
                                        ...
                                        <div class="flex flex-row mt-1 ">
                                            <dt class="w-1/4 mb-1 text-black text-[0.6rem] sm:text-xs font-semibold ">

                                            </dt>
                                            <dd class="pl-2 text-[0.6rem] sm:text-xs inline-block text-[#686464] text-black capitalize hidden sm:block">
                                ...
                                <div class="col-span-12">
                                    <div class="col-span-6  grid md:grid-cols-2 gap-4 md:col-span-8">
                                      <div class="flex flex-row items-center">
                                        <dt class="mb-1  w-1/4 text-[0.6rem] sm:text-xs font-semibold text-black">Address</dt>
                                        <dd class="text-[0.6rem] sm:text-xs capitalize ml-3 text-black">
                                  ...
                                  {{-- <div class="flex flex-row mt-3 block sm:hidden">
                                    <dt
                                        class="w-1/4 mb-1 text-black text-[0.6rem] sm:text-xs font-semibold  whitespace-nowrap">
                                        Series No.
                                    </dt>
                                    @if ($selectedUser == !null)
                                        <dd
                                            class="pl-2 text-[0.6rem] sm:text-xs  capitalize
                                        @if (isset($selectedUser['challanSeries'])) @if ($selectedUser['challanSeries'] == 'Not Assigned') text-red-700
                                            @else text-black @endif
                                @else
                                text-black @endif">

                                {{ $selectedUser['challanSeries'] ?? null }}{{ '-' }}<input type="text" name="seriesNumber" value="{{ $selectedUser['seriesNumber'] ?? null }}" class="border rounded px-2 py-1 text-[0.6rem] sm:text-xs">
                                        </dd>
                                    @endif
                                </div> --}}
                                {{-- @dump($selectedUser) --}}
                                @if ($selectedUser != null && !empty($selectedUser['gst']))
                                    <div class="flex flex-row mt-3 block sm:hidden">
                                        ...
                                        <dd class="text-[0.6rem] sm:text-xs ml-2 capitalize text-black"> {{ $selectedUser['gst'] }} </dd>
                                    </div>
                                @endif

                                @if($additionalNumberPermission)
                                            <div class="flex flex-row mt-3 block sm:hidden">
                                                {{-- <dt class="mb-1  w-1/4 text-[0.6rem] sm:text-xs font-semibold text-black">Add Number</dt> --}}
                                                      ...
                                                      class="hsn-box h-5 sm:h-7 w-32 pl-2 rounded-lg bg-white border border-gray-400 border-solid text-[0.6rem] sm:text-xs  text-black focus:outline-none"
                                  ...
                                  <div class="col-span-12">
                                    <div class="col-span-6 grid md:grid-cols-2 gap-4 md:col-span-8">
                                      <div class="flex flex-row items-center">
                                        @if ($selectedUser != null && !empty($selectedUser['gst']))
                                        <dt class="mb-1  w-1/4 text-[0.6rem] sm:text-xs font-semibold text-black">GST</dt>
                                        <dd class="text-[0.6rem] sm:text-xs ml-2 capitalize text-black">{{ $selectedUser['gst'] ?? null }}</dd>
                                        @endif
                                    </div>
                                    </div>
                                  </div>
                                    ...
                                    <div class="col-span-12">
                                        ...
                                        <div class="flex flex-row items-center">
                                            {{-- <dt class="mb-1  w-1/4 text-[0.6rem] sm:text-xs font-semibold text-black">Add Number</dt> --}}
                                              ...
                                              <input @if ($inputsDisabled == true) disabled="" @endif placeholder="Add number"
                                              wire:model.defer="createChallanRequest.additional_phone_number"
                                              class="hsn-box h-5 sm:h-7 w-32 ml-2 rounded-lg bg-white border border-gray-400 border-solid text-[0.6rem] sm:text-xs  text-black focus:outline-none"
                                              min="0" type="number" maxlength="10"/>
                                            </div>
                                        </div>
                                    </div>
                                  ...
                                  {{-- <div class="col-span-12">
                                    <div class="col-span-6 grid md:grid-cols-2 gap-4 md:col-span-8">
                                        <div x-data="{ open: false }" class="flex">
                                            ...
                                            <dt class="mb-1  w-1/4 text-[0.6rem] sm:text-xs font-semibold text-black"  @click="open = ! open">Add Number</dt>
                                            <dd class="text-[0.6rem] sm:text-xs ml-2 capitalize text-black" x-show="open" @click.outside="open = false">Contents</dd>
                                        </div>
                                    </div>
                                  </div> --}}
                            </div>
                            ...
                            <div class="gap-2 grid grid-cols-12  " >
                                ...
                                <!-- Your add user form goes here -->
                                    <div class="grid gap-2" wire:ignore>
                                        <div class="flex flex-row mt-2 items-center">
                                            <dt class="mb-1 text-black text-[0.6rem] sm:text-xs  w-24">Name</dt>
                                            <input @if ($inputsDisabled == true)  @endif
                                                wire:model.defer="addReceiverData.receiver_name"
                                                class="hsn-box h-5 sm:h-7 w-2/3  text-[0.6rem] sm:text-xs rounded-lg bg-white border border-gray-400 border-solid text-black focus:outline-none"
                                                type="text" maxlength="40" oninput="if(this.value.length > 40) this.value = this.value.slice(0, 40);"   />
                                        </div>
                                        <div class="flex flex-row mt-2 items-center">
                                            <dt class="mb-1 text-black text-[0.6rem] sm:text-xs w-24">Phone</dt>
                                            <div class="w-2/3">
                                            <input @if ($inputsDisabled == true) disabled @endif
                                                wire:model.defer="addReceiverData.phone" id="phone"
                                                class="hsn-box h-5 sm:h-7 w-full text-[0.6rem] sm:text-xs rounded-lg bg-white border border-gray-400 border-solid text-black focus:outline-none"
                                                type="number" max="9999999999" maxlength="10"
                                                oninput="if(this.value.length > 10) this.value = this.value.slice(0, 10);" />
                                                <div id="phone_error" class="text-red-500 text-[0.6rem] sm:text-xs mt-1"> </div>
                                            </div>
                                        </div>
                                        <div class="flex flex-row mt-2 items-center">
                                            <dt class="mb-1 text-black text-[0.6rem] sm:text-xs  w-24">Email</dt>
                                            <div class="w-2/3">
                                                ...
                                                <!-- Error message for email validation -->
                                                    <div id="email_error" class="text-red-500 text-[0.6rem] sm:text-xs mt-1"> </div>
                                            </div>
                                        </div>

                                        <div class="flex flex-row mt-2 items-center">
                                            <dt class="mb-1 text-black text-[0.6rem] sm:text-xs  w-24">Company </dt>
                                            <input @if ($inputsDisabled == true)  @endif
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <div class="grid gap-2"  wire:ignore>
                                        ...
                                        <div class="flex flex-row mt-2 items-center">
                                            <dt class="mb-1 text-black text-[0.6rem] sm:text-xs  w-24">Address</dt>
                                            <input @if ($inputsDisabled == true)  @endif
                                        ...
                                        <div class="flex-row mt-2 hidden sm:flex">
                                            <dt class="mb-1 text-black text-[0.6rem] sm:text-xs w-24">Pincode</dt>
                                            <input @if ($inputsDisabled == true) @endif
                                            ...
                                            class="hsn-box h-5 sm:h-7 w-1/4  text-[0.6rem] sm:text-xs rounded-lg bg-white border border-gray-400 border-solid text-black focus:outline-none"
                                            type="text" />

                                            <dt class="mb-1 text-black text-[0.6rem] sm:text-xs mt-1 ml-5 mr-10">City</dt>
                                        ...
                                        <div class="flex mt-2 flex-none sm:hidden">
                                            ...
                                            <dt class="mb-1 text-black text-[0.6rem] sm:text-xs  w-24">City</dt>
                                        ...
                                        <div class="flex flex-row mt-2 items-center">
                                           ...
                                           <dt class="mb-1 text-black text-[0.6rem] sm:text-xs  w-24">State</dt>
                                            <input @if ($inputsDisabled == true) @endif
                                        ...
                                        <div class="flex flex-row mt-2 items-center">
                                            <dt class="mb-1 text-black text-[0.6rem] sm:text-xs  w-24">Gst</dt>
                                            <input @if ($inputsDisabled == true)  @endif
                    ...
                    <div class=" grid-rows-3 ml-20 hidden sm:block ">
                        <div class="flex flex-row">
                            <dt class="w-24 mb-1 text-black text-[0.6rem] sm:text-xs font-semibold my-auto ">
                                Date
                            </dt>
                            <dd class="pl-2 text-[0.6rem] sm:text-xs inline-block  text-black capitalize hidden sm:block">
                        ...
                        <div class="flex flex-row mt-3">
                            <dt class="w-24 mb-1 text-black text-[0.6rem] sm:text-xs font-semibold whitespace-nowrap">
                                Series No.
                            </dt>
                            @if ($selectedUser != null)
                                <dd class="pl-2 text-[0.6rem] sm:text-xs capitalize
                                    @if (isset($selectedUser['challanSeries']))
                                        @if ($selectedUser['challanSeries'] == 'Not Assigned')
                                            text-red-700
                                        @else
                        ...
                        <div class="flex flex-row mt-3">
                            <dt
                                class="w-24 mb-1 text-black text-[0.6rem] sm:text-xs font-semibold  whitespace-nowrap">
                                GST
                            </dt>
                            @if ($selectedUser == !null)
                                <dd class="text-[0.6rem] sm:text-xs ml-2 capitalize text-black"> {{ $selectedUser['gst'] ?? null }} </dd>
                        ...
                        @if($additionalNumberPermission)
                                    <div class="flex flex-row mt-3">
                                        {{-- <dt class="mb-1  w-24 text-[0.6rem] sm:text-xs font-semibold text-black">Add Number</dt> --}}
                                              {{-- <input type="text" placeholder="Additional Number" wire:model.defer="createChallanRequest.additional_phone_number" class="input input-bordered input-sm w-full max-w-xs bg-white border border-gray-400 border-solid"  @if ($inputsDisabled == true) disabled="" @endif     maxlength="10" />  --}}
                                              <input @if ($inputsDisabled == true) disabled="" @endif placeholder="Add number"
                                              wire:model.defer="createChallanRequest.additional_phone_number"
                                              class="hsn-box h-5 sm:h-7 w-32 rounded-lg bg-white border border-gray-400 border-solid text-[0.6rem] sm:text-xs  text-black focus:outline-none"
                                              min="0" type="number" maxlength="10"/>
                                    </div>
                                    @endif
                    </div>
                ...
                <div class="w-full h-full p-2 border border-gray-200 rounded-lg shadow sm:p-4 bg-[#ebebeb]">
                    ...
                    <div x-data="{ search: '', selectedUserDetails: null }" wire:ignore.self>
                        ...
                        <button id="dropdownDetailSearchButton outlined" data-dropdown-toggle="dropdownDetailSearch"
                            data-dropdown-placement="bottom" data-dropdown-trigger="click"
                            class=" flex w-full text-black border border-gray-400 border-solid  bg-white focus:ring-2 focus:outline-none focus:ring-[#372b2b]/50 font-medium rounded-lg text-[0.6rem] sm:text-xs px-5 py-1.5 text-center items-center justify-center dark:focus:ring-gray-900 dark:hover:bg-[#050708]/30 mr-2 mb-2"
                            type="button">
                            @if ($receiverAddress == '')
                    ...
                    <div class="grid gap-2">
                        ...
                        @if ($selectedUser != null && !empty($selectedUser['gst']))
                            <div class="flex flex-row">
                                <dt class="mb-1 text-black text-[0.6rem] sm:text-xs font-semibold w-1/4">GST</dt>
                                <dd class="pl-2 text-[0.6rem] sm:text-xs text-[#686464] text-black capitalize">
                                    {{ $selectedUser['gst'] }}
                                </dd>
                            </div>
                        @endif
                        <div class="flex flex-row">
                            <dt class="mb-1 text-black text-[0.6rem] sm:text-xs font-semibold w-1/4">Address</dt>
                            <dd class="pl-2 text-[0.6rem] sm:text-xs text-[#686464] text-black capitalize">
        ...
        <div wire:loading    class="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <span   class="loading loading-spinner loading-md"></span>
                ...
                <div  x-data="{ open: false }">
                    @if($disabledButtons)
                    <div class="border-b border-gray-300 pb-4 px-1 flex items-center flex-wrap gap-2 justify-between sm:indicator ">
                        <button wire:click.prevent="addRow" @if ($inputsDisabled == true) disabled @endif
                            class="rounded-full bg-yellow-500 px-3  text-[0.6rem] text-xs shadow-lg text-black hover:bg-yellow-700 h-5 sm:h-7"
                        ...
                        @if($products)
                            <button @click="open = true" type="button" @if ($inputsDisabled == true) disabled @endif
                                class="rounded-full bg-yellow-500 px-3 py-1.5 text-[0.6rem] sm:text-xs shadow-lg text-black hover:bg-yellow-700 sm:h-5 sm:h-7"
                                style="background-color: #e5f811;">
                        ...
                        <div class=" flex-col hidden sm:flex">
                            @if(auth()->user()->barcode)
                                <input class="text-black text-[0.6rem] sm:text-xs border border-solid rounded-lg h-5 sm:h-7 w-full sm:w-auto px-2"
                                    @if ($inputsDisabled == true) disabled @endif
                                    wire:model.debounce.500ms="barcode"
                                    type="text"
                                    placeholder="Scan Barcode">
                                @if ($barcodeError)
                                    <span class="text-red-500 text-[0.6rem] sm:text-xs mt-1">{{ $barcodeError }}</span>
                                @endif
                            @endif
                        </div>
                        ...
                        <!-- Modal content -->
                        <div  x-show="open" x-cloak class="fixed inset-0 flex items-center sm:justify-center  overflow-x-auto md:ml-64 bg-opacity-50 backdrop-blur-sm z-10  " >
                                ...
                                <div class="">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="items-start justify-between p-2 border-b rounded-t dark:border-gray-600">
                                            <button type="button" @click="open = false" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-[0.6rem] sm:text-xs w-8 h-9 inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"  >
                                                <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                                </svg>
                                                <span class="sr-only">Close modal</span>
                                            </button>
                                            <button type="button" @click="open = false; sendData()" class="text-white bg-gray-900 hover:bg-orange hover:text-black focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-[0.6rem] sm:text-xs px-5 py-2.5 text-center dark:hover:bg-orange dark:focus:ring-blue-800 mr-5 ml-auto">Add</button>
                                        </div>
                                        @if($inputsDisabled == false)
                                        <!-- Modal body -->
                                        <div class="p-2 space-y-6 h-80 overflow-y-auto" @click.stop>
                                            ...
                                            <table class="w-full text-[0.6rem] sm:text-xs text-left text-black dark:text-gray-400 overflow-x-auto">
                                                <thead class="text-[0.6rem] sm:text-xs text-black bg-gray-300 dark:bg-gray-700 dark:text-gray-400 whitespace-nowrap">
                                                    <th scope="col" class="va-b px-2 py-1 text-[0.6rem] sm:text-xs border-2 border-gray-300">Action</th>
                                                    <th scope="col" class="va-b px-2 py-1 text-[0.6rem] sm:text-xs border-2 border-gray-300">S. No.</th>
                                                    @foreach ($ColumnDisplayNames as $index => $columnName)
                                                    @if (!empty($columnName))
                                                    <th class="va-b px-2 py-2 text-[0.6rem] sm:text-xs border border-gray-300 whitespace-nowrap">
                                                        @if ($index >= 3 && $index <= 6)
                                                ...
                                                <tbody class="stock-table">
                                                    ...
                                                    <tr class="@if ($key % 2 == 0) border-b bg-[#e9e6e6] dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600 @else bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-600 @endif whitespace-nowrap">
                                                        <th scope="row" class="flex items-center whitespace-nowrap px-1 py-1 text-[0.6rem] sm:text-xs border-2 border-gray-300 text-gray-900 dark:text-white">
                                                        ...
                                                        <td class="px-2 py-1 text-[0.6rem] sm:text-xs border-2 border-gray-300">{{ ++$key }}</td>
                                                        ...
                                                        @break
                                                        @endif
                                                        <td class="px-1 py-2 text-[0.6rem] sm:text-xs border-2 border-gray-300">
                                                            {{ $column->column_value }}
                                                        </td>
                                                        @endif
                                                        @endforeach
                                                        <td class="px-2 py-1 text-[0.6rem] sm:text-xs border-2 border-gray-300">{{ $product->item_code }}</td>
                                                        <td class="px-2 py-1 text-[0.6rem] sm:text-xs border-2 border-gray-300">{{ $product->category }}</td>
                                                        <td class="px-2 py-1 text-[0.6rem] sm:text-xs border-2 border-gray-300">{{ $product->location }}</td>
                                                        <td class="px-2 py-1 text-[0.6rem] sm:text-xs border-2 border-gray-300">{{ $product->warehouse }}</td>
                                                        <td class="px-2 py -1 text-[0.6rem] sm:text-xs border-2 border-gray-300 Unit">{{ $product->unit }}</td>
                                                        <td class="px-2 py-1 text-[0.6rem] sm:text-xs border-2 border-gray-300">{{ $product->qty }}</td>
                                                        <td class="px-2 py-1 text-[0.6rem] sm:text-xs border-2 border-gray-300">{{ $product->rate }}</td>
                                                    </tr>
                                                    @endif
                                                    @endforeach
                                                    </tbody>
                    ...
                    <div class="flex flex-col">
                                    ...
                                    <table class="min-w-full w-full">
                                        <thead>
                                            <tr class="border-b border-gray-300 text-left whitespace-nowrap">
                                                <th class="px-2  text-[0.6rem] sm:text-xs text-black">#</th>

                                                @foreach ($panelColumnDisplayNames as $columnName)
                                                    @if (!empty($columnName))
                                                        <th class="px-2  text-[0.6rem] sm:text-xs text-black">{{ $columnName }}
                                                ...
                                                <th class="px-2  text-[0.6rem] sm:text-xs text-black">Unit</th>
                                                {{-- <th class="px-2  text-[0.6rem] sm:text-xs text-black">Details</th> --}}


                                                @if(Auth::getDefaultDriver() == 'team-user' ? Auth::guard(Auth::getDefaultDriver())->user()->team_owner_user_id : Auth::guard(Auth::getDefaultDriver())->user()->show_rate == 1)
                                                <th class="px-2  text-[0.6rem] sm:text-xs text-black">Rate</th>
                                                @endif
                                                <th class="px-2  text-[0.6rem] sm:text-xs text-black">Qty
                                                    <span class="text-red-500">*</span>
                                                 <span> @if(isset($errorQty) && $errorQty)
                                                    {{-- <span class="text-red-500 text-[0.6rem] sm:text-xs">{{ $errorQty[$index] }}</span> --}}
                                                @endif</span></th>
                                                @if($pdfData->challan_templete == 4 )
                                                <th class="px-2 text-[0.6rem] sm:text-xs text-black">Tax(%)</th>
                                                 @endif
                                               <th class="px-2  text-[0.6rem] sm:text-xs text-black">Total Amount</th>
                                                <th class="px-2  text-[0.6rem] sm:text-xs text-black"></th>
                                            </tr>
                                            @php
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($createChallanRequest['order_details'] as $index => $row)
                                                <tr>
                                                    <td class="px-1 py-2">
                                                        <span class="hsn-box h-5 sm:h-7 mb-1 resize-x w-10 rounded-lg border-gray-400 border-solid text-[0.6rem] sm:text-xs text-black">
                                                            {{ $index + 1 }}
                                                        </span>
                                                    </td>
                                                        ...
                                                        <td class="px-1 py-2">
                                                            ...
                                                            <div x-data="{ search: '', showDropdown: false }" @click.away="showDropdown = false">
                                                                ...
                                                                <label class="input-sizer" wire:ignore>
                                                                    <input type="text"
                                                                        ...
                                                                        class="rounded-lg bg-white text-black text-[0.6rem] sm:text-xs h-5 sm:h-7 border border-gray-400 border-solid"
                                                                        onInput="this.parentNode.dataset.value = this.value.slice(0, 20)"
                                                                        maxlength="20" size="9" />
                                                                </label>
                                                                @error('article.' . $index)
                                                                <div class="text-[0.6rem] sm:text-xs text-red-500">{{ $message }}</div>
                                                                @enderror
                                                                ...
                                                                <ul x-show="search !== '' && showDropdown" class="absolute mt-1 sm:w-72 max-h-64 overflow-auto bg-white rounded-lg shadow-lg z-10" x-cloak x-data="{ hasMatchingResult: false }" x-init="$watch('search', value => { hasMatchingResult = false; })">
                                                                        ...
                                                                        @foreach($articleDetails as $detail)
                                                                            ...
                                                                            <li class="cursor-pointer p-0.5 hover:bg-gray-100" x-show="'{{ strtolower($detail->column_value) }}'.includes(search)" x-init="$watch('search', value => { if ('{{ strtolower($detail->column_value) }}'.includes(value)) { hasMatchingResult = true; } })">
                                                                                <div class="flex items-center rounded hover:bg-gray-100 cursor-pointer dark:hover:bg-gray-600">
                                                                                    ...
                                                                                    onclick="window.selectProduct({{ json_encode($product) }}, '{{ $product->id }}')"
                                                                                    data-product-id="{{ $product->id }}">
                                                                                    <label class="w-full px-2 p-1.5 text-[0.6rem] sm:text-xs font-medium text-gray-900 rounded cursor-pointer dark:text-gray-300">{{ $detail->column_value }}</label>
                                                                                </div>
                                                                            </li>
                                                                        @endforeach
                                                                    @endforeach
                                                                    ...
                                                                    <li class="p-2 sticky bottom-0 bg-white" x-show="hasMatchingResult">
                                                                        <button type="button" @click="sendData(); showDropdown = false;" class="text-white bg-gray-900 hover:bg-orange hover:text-black focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-[0.6rem] sm:text-xs px-5 py-2.5 text-center dark:hover:bg-orange dark:focus:ring-blue-800 mr-5 ml-auto">Add</button>
                                                                    </li>
                                                                </ul>
                                                                @endif
                                                            </div>
                                                            ...
                                                            @else
                                                                {{-- <input
                                                                    @if ($inputsDisabled == true) disabled @endif
                                                                    wire:model.defer="createChallanRequest.order_details.{{ $index }}.columns.{{ $key }}.column_value"
                                                                    class="hsn-box h-5 sm:h-7 w-24 dynamic-width-input rounded-lg bg-white border border-gray-400 border-solid text-[0.6rem] sm:text-xs text-black focus:outline-none"
                                                                    type="text"
                                                                /> --}}
                                                                <label class="input-sizer" wire:ignore>
                                                                    <input type="text"
                                                                        @if ($inputsDisabled == true) disabled @endif
                                                                        wire:model.defer="createChallanRequest.order_details.{{ $index }}.columns.{{ $key }}.column_value"
                                                                        class="rounded-lg w-20 bg-white text-black text-[0.6rem] sm:text-xs h-5 sm:h-7 border border-gray-400 border-solid"
                                                                        onInput="this.parentNode.dataset.value = this.value.slice(0, 20)"
                                                                        maxlength="50" size="9" />
                                                                </label>
                                                    ...
                                                    <td class="max-w-sm mx-auto" wire:ignore.self>
                                                        <select wire:ignore wire:model.defer="createChallanRequest.order_details.{{ $index }}.unit" class="bg-white border px-2 border-gray-400 border-solid text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block text-[0.6rem] h-5 w-20 sm:h-7 sm:h-auto sm:text-xs p-0 sm:p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                    ...
                                                    <script>
                                                          document.addEventListener('DOMContentLoaded', function () {
                                                            const validFromInput = document.getElementById('datepicker-autohide');
                                                            ...
                                                            validFromInput.addEventListener('changeDate', function (event) {
                                                                @this.set('createChallanRequest.challan_date', event.target.value);
                                                    ...
                                                    <td hidden class="px-1 py-2">
                                                        <input @if ($inputsDisabled == true) disabled="" @endif
                                                            class="hsn-box h-5 sm:h-7 w-25 rounded-lg bg-white border border-gray-400 border-solid text-[0.6rem] sm:text-xs  text-black focus:outline-none"
                                                            type="text" />
                                                    </td>
                                                    @if(Auth::getDefaultDriver() == 'team-user' ? Auth::guard(Auth::getDefaultDriver())->user()->team_owner_user_id : Auth::guard(Auth::getDefaultDriver())->user()->show_rate == 1)
                                                    <td class="px-2 py-2">
                                                        <input @if ($inputsDisabled == true) disabled="" @endif
                                                            class="rate hsn-box h-5 sm:h-7 w-24 rounded-lg bg-white border border-gray-400 border-solid text-[0.6rem] sm:text-xs  text-black focus:outline-none"
                                                            min="0" type="number" wire:model.defer="createChallanRequest.order_details.{{ $index }}.rate" data-index="{{ $index }}"/>
                                                    </td>
                                                    @endif
                                                    <td class="px-2 py-2">
                                                        <input @if ($inputsDisabled == true) disabled="" @endif
                                                            class="qty hsn-box h-5 sm:h-7 mt-1 sm:mt-0 w-24 flex rounded-lg  text-center  text-[0.6rem] sm:text-xs  text-black  @if(isset($errorQty[$index]) && $errorQty[$index]) bg-red-500 @else bg-white border border-gray-400 border-solid @endif "
                                                    ...
                                                    @if($pdfData->challan_templete == 4 )
                                                        <td class="px-2 py-2 ">
                                                            <input @if ($inputsDisabled == true) disabled="" @endif class=" tax hsn-box h-5 sm:h-7 w-12 sm:w-24 rounded-lg bg-white border border-gray-400 border-solid text-[0.6rem] sm:text-xs text-black focus:outline-none" min="0" type="number" wire:model.defer="createChallanRequest.order_details.{{ $index }}.tax" data-index="{{ $index }}" data-tax-index="{{ $index }}"/>
                                                        </td>
                                                    @endif
                                                    ...
                                                    <td class="px-2 py-2 w-0" wire:ignore>
                                                        <input @if ($inputsDisabled == true) disabled @endif x-ignore
                                                            ...
                                                            class="hsn-box h-5 sm:h-7  rounded-lg bg-white border border-gray-400 w-24 border-solid text-[0.6rem] sm:text-xs text-black focus:outline-none total"
                                                            type="number" data-index="{{ $index }}" oninput="adjustWidth(this)" readonly />

                                                            {{-- <input @if ($inputsDisabled == true) disabled="" @endif
                                                            wire:model.defer="createChallanRequest.order_details.{{ $index }}.total_amount"
                                                            class="hsn-box h-5 sm:h-7 px-0 rounded-lg bg-white border border-gray-400 text-[0.6rem] sm:text-xs text-black focus:outline-none total dynamic-width"
                        ...
                        <script>
                            function adjustWidth(input) {
                                ...
                                input.style.width = (width + 20) + 'px'; // Add some extra padding
                            }
...
<div class="border-b border-gray-400 gap-4 grid grid-cols-1 md:grid-cols-2 mt-4 pb-2 ml-1">
    <div>
        <label for="comment" class="block text-[0.6rem] sm:text-xs font-medium text-gray-700">Comment</label>
        <input @if ($inputsDisabled == true) disabled @endif
            ...
            <div class="mt-4">
                <label for="totalAmountInWords" class="block text-[0.6rem] sm:text-xs font-medium text-gray-700">Total Amount in Words</label>
                <input @if ($inputsDisabled == true) disabled @endif
                    class="mt-1 hsn-box h-5 sm:h-7 w-full rounded-lg bg-white border border-gray-400 border-solid text-[0.6rem] sm:text-xs text-black focus:outline-none"
                    type="text" id="totalAmountInWords" disabled />
            </div>
    </div>
    <div class="space-y-2 mr-2 p-2 sm:{{ $mrClass }} sm:{{ $prClass }}">
        @foreach ($createChallanRequest['order_details'] as $index => $row)
        <!-- Blade template section for displaying calculations -->
        <div id="totals-container" class="text-right text-[0.6rem] sm:text-xs text-black"></div>
        @endforeach
        <div class="flex justify-between items-center">
            <label for="discount" class="text-[0.6rem] sm:text-xs font-medium text-gray-700">Discount</label>
            <input @if ($inputsDisabled == true) readonly @endif
                wire:model.defer="discount_total_amount"
                class="hsn-box h-5 sm:h-7 w-24 rounded-lg text-right bg-white border border-gray-400 border-solid text-[0.6rem] sm:text-xs text-black focus:outline-none discount"
                type="number" />
        </div>
        <div class="flex justify-between items-center">
            <label for="roundOff" class="flex items-center text-[0.6rem] sm:text-xs font-medium text-gray-700">
                <span class="">Round Off</span>
                <input id="vue-checkbox-list" @if ($inputsDisabled == true) disabled @endif
                    type="checkbox" value=""
                    class="w-4 h-4 ml-2 text-right text-gray-600 border-solid cursor-pointer bg-white rounded focus:ring-gray-500 dark:focus:ring-gray-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
            </label>
            <input class="hsn-box h-5 sm:h-7 w-24 text-right rounded-lg bg-white border border-gray-400 border-solid text-[0.6rem] sm:text-xs text-black focus:outline-none"
                type="text" id="roundOffAmount" readonly value="" />
            <input type="hidden" wire:model.defer="createChallanRequest.round_off" />
        </div>
        <div class="flex justify-between items-center">
            <label for="totalQty" class="text-[0.6rem] sm:text-xs font-medium text-gray-700">Total Qty</label>
            <input @if ($inputsDisabled == true) readonly @endif
                class="bg-transparent border-none focus:outline-none font-bold h-5 p-0 sm:h-7 hsn-box rounded-lg text-black text-right text-[0.6rem] sm:text-xs totalQtyField"
        ...
        <div class="flex justify-between items-center">
            <label for="totalAmount" class="text-[0.6rem] sm:text-xs font-medium text-gray-700">Total Amount</label>
            <input @if ($inputsDisabled == true) readonly @endif
                class="bg-transparent border-transparent font-bold h-5 sm:h-7 hsn-box p-0 rounded-lg text-black text-right text-[0.6rem] sm:text-xs totalAmountField"
    ...
    document.addEventListener('click', (e) => {
        ...
        <dialog id="my_modal_1" class="modal" wire:ignore>
            ...
            <div class="grid grid-cols-2 gap-4 mt-2 text-[0.6rem] sm:text-xs">
                <!-- Left side (Dropdown) -->
                <div class="relative">
                    <input
                    ...
                    <div
                        ...
                        class="absolute z-10 w-full mt-1 text-[0.6rem] sm:text-xs bg-white rounded-md shadow-lg hidden"
                        >
            ...
            <div class="flex justify-end">
                <button  type="button" wire:click='sfpChallan'
                    class="text-white btn btn-sm mt-6 btn-circle btn-ghost bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-[0.6rem] sm:text-xs border-2 border-gray-300 px-10 py-1.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send</button>
            </div>
        </div>
    </dialog>
    ...
    <script>
        function debounce(func, wait) {
         ...
         function updateTotals() {
            ...
            totalsContainer.innerHTML += `
                <div style="display: flex; justify-content: end; width: 100%; margin-bottom: 5px;">
                    <div style="text-align: right; width: 50%;">
                        ${tax > 0 ? `<div>Sales at ${tax}%:</div>` : ''}
                        ${rowDiscounts[tax] > 0 ? `<div>Discount at ${discount}%:</div>
                                                <div><strong>Amount at ${discount}%:</strong></div>` : ''}
                        ${tax > 0 ? `<div>SGST ${(tax / 2).toFixed(2)}%:</div>
                                    <div>CGST ${(tax / 2).toFixed(2)}%:</div>` : ''}
                    </div>
                    <div style="text-align: right; width: 30%;">
                        ${tax > 0 ? `<div>${totalWithoutTax}</div>` : ''}
                        ${rowDiscounts[tax] > 0 ? `<div>${rowDiscounts[tax].toFixed(2)}</div>
                                                <div><strong>${discountedTotalAmounts}</strong></div>` : ''}
                        ${tax > 0 ? `<div>${(taxAmounts / 2).toFixed(2)}</div>
                                    <div>${(taxAmounts / 2).toFixed(2)}</div>` : ''}
                    </div>
                </div>`;
        }
            ...
            totalsContainer.innerHTML += `
                <div style="display: flex; justify-content: space-between; width: 100%; margin-bottom: 5px;">
                    <div style="text-align: left; width: 50%;">
                        <div>Discount at ${discount}%:</div>
                        <div><strong>Net Sale:</strong></div>
                    </div>
                    <div style="text-align: right; width: 30%;">
                        <div>${discountAmount.toFixed(2)}</div>
                        <div><strong>${discountedTotalAmount.toFixed(2)}</strong></div>
                    </div>
                </div>`;
}
