        ...
        @foreach ($tableTdData as $key => $columnName)
            ...
            <tr
                ...
                <td class="px-2  text-[0.6rem] border-2 border-gray-300 ">
                    {{ $columnName->custom_item_number }}</div>
                </td>
                ...
                @if(isset($columnName->statuses[0]) && $columnName->statuses[0]->status == 'reject') bg-red-500 @endif">
                    ...
                    <span class="text-red-500">Created</span>
                        ...
                        Self Returned
                    @endif
                        {{-- {{ ucfirst($columnName->statuses[0]->status) }}  --}}
                ...
                {{-- <td class="px-2  text-[0.6rem] border-2 border-gray-300 border-2 border-gray-300"></td> --}}
                {{-- @dd($columnName); --}}
                {{-- href="#my_modal_8"
                wire:click="updateVariable('challan_sfp', {{ json_encode($columnName->sfp) }})" --}}
                <td class="border-2 border-gray-300">
                    <a
                        data-modal-target="sfp-{{ json_encode($columnName->sfp) }}"
                        data-modal-toggle="sfp-{{ json_encode($columnName->sfp) }}"
                        class="block px-4
                ...
                {{-- @dump($columnName->sfp) --}}
                {{-- <td class="border-2 border-gray-300">
                    <a  data-modal-target="sfp-{{$columnName->sfp }}"
                        data-modal-toggle="sfp-{{$columnName->sfp }}"
                        class="block px-4
                ...
                <div id="sfp-{{ json_encode($columnName->sfp) }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="flex items-center justify-between p-3 border-b rounded-t dark:border-gray-600">
                                ...
                                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm h-8 w-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="sfp-{{ json_encode($columnName->sfp) }}">
                ...
                <td class="px-2 text-[0.6rem] border-2 border-gray-300 whitespace-normal "
                    data-modal-target="timeline-modal-{{ $columnName->id }}"
                    data-modal-toggle="timeline-modal-{{ $columnName->id }}"
                    >
                    @php
                ...
                <div id="timeline-modal-{{ $columnName->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        <!-- Modal content -->
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <!-- Modal header -->
                            <div class="flex items-center justify-between p-2 px-3 rounded-t dark:border-gray-600">
                                ...
                                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm h-8 w-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="timeline-modal-{{ $columnName->id }}">
                                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                                    </svg>
                                    <span class="sr-only">Close modal</span>
                        ...
                        @if (isset($columnName->statuses[0]))
                            <ul class=" text-[0.6rem] border-2 border-gray-300 text-gray-700 dark:text-gray-200"
                                ...
                                @if((isset($columnName->statuses[0]->status) && $columnName->statuses[0]->status !== 'sent'))
                                    @if($teamMembers != null)
                                    <li>
                                        <a href="javascript:void(0);" data-modal-target="edit-modal"
                                ...
                                @if($columnName->receiver_id)
                                    @if ($columnName->statuses[0]->status == 'draft')
                                        @if ($mainUser->team_user != null)
                                            ...
                                            @endif
                                        @else
                                        <li> <a data-modal-target="default-modal" data-modal-toggle="default-modal" onclick="setModalData({{ $columnName->id }})" class="block px-4 py-1 hover:bg-orange dark:hover:bg-gray-600 dark:hover:text-white">Send</a> </li>
                                        @endif
                                    @endif
                                @endif
                                ...
                                @if($columnName->receiver_id)
                                    ...
                                    @foreach($columnName->order_details as $order)
                                        ...
                                        @if ($columnName->statuses[0]->status == 'self_accept' ||
                                            ...
                                            @if ($mainUser->team_user != null)
                                                @if ($mainUser->team_user->permissions->permission->sender->accept_challan == 1)
                                                    <li>
                                                        <a href="#"
                                                            wire:click="innerFeatureRedirect('self_return_challan', {{ $columnName->receiver_id }})"
                                                            class="block px-4 py-1 hover:bg-orange dark:hover:bg-gray-600 dark:hover:text-white">Self
                                                            Return</a>
                                                    </li>
                                                @endif
                    ...
                    observe() {
                        const observer = new IntersectionObserver(entries => {
                            entries.forEach(entry => {
                                if (entry.isIntersecting && @this.tableTdData.length < 100){
                                    @this.loadMore();
                                }
                            });
                        });
            ...
            <tr
                ...
                <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300
                    ...
                    <span class="text-red-500">Created</span>
                        ...
                        Self Delivered
                        @elseif($columnName->statuses[0]->status == 'accept')
                        Accepted By {{ $columnName->receiver }}
                        @elseif($columnName->statuses[0]->status == 'reject')
                        Rejected By {{ $columnName->receiver }}
                        @elseif($columnName->statuses[0]->status == 'partially_self_return')
                        Partial Self Returned
                        @elseif($columnName->statuses[0]->status == 'self_return')
                        Self Returned
        ...
        @if (isset($columnName->statuses) && count($columnName->statuses) > 0)
            ...
            @if (in_array($latestStatus->status, ['sent', 'accept', 'modified', 'reject','self_accept','self_return','partially_self_return']))
                <tr
                    ...
                    {{-- {{dd($columnName)}} --}}
                    <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300">
                        {{ $columnName->receiver_details->details->state ?? $columnName->receiver_user->state }}</td>
                        <td class="px-2  text-[0.6rem] border-2 border-gray-300
                        @if(isset($columnName->statuses[0]) && $columnName->statuses[0]->status == 'reject') bg-red-500 @endif">
                            @if (isset($columnName->statuses[0]))
                            @php
    ...
    @foreach ($this->invoiceData as $key => $columnName)
        <tr
            ...
            <th scope="row"
                ...
                <div class="pl-0">
                    <div class="text-[0.6rem] border-2 border-gray-300 font-xs">{{ ++$key }}</div>
...
{{-- SELLER PANLE --}}
@if (!is_null($this->tableTdData) && $this->persistedTemplate == 'sent_invoice')
    @php
        $mainUser = json_decode($this->mainUser);
    @endphp
    @foreach ($this->tableTdData as $key => $columnName)
    @php
            ...
            @endphp
        <tr
            class="@if ($key % 2 == 0)  bg-[#e9e6e6] dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600 @else bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-600 @endif">

                    <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300">{{ ++$key }}</td>
            ...
            <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300">{{ $columnName->seller }}</td>
            <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300">{{ $columnName->total }}</td>
            <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300">{{ $columnName->receiver_details->state ?? '' }}</td>
            ...
            <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300">
                <a data-modal-target="sfp-sent-invoice-{{ json_encode($columnName->sfp) }}"
                    data-modal-toggle="sfp-sent-invoice-{{ json_encode($columnName->sfp) }}"
                    ...
                    @if (count($columnName->sfp) > 0) text-white
                        @foreach ($columnName->sfp as $sfp)
                            @if (isset($sfp->sfp_by_id) && $sfp->sfp_by_id == Auth::user()->id)
                                bg-red-600
                            @elseif (isset($columnName->statuses[0]->status) && $columnName->statuses[0]->status == 'sent')
                                bg-green-600
                            @else
                                bg-red-600
                            @endif
            ...
            <td class="px-2 text-[0.6rem] border-2 border-gray-300 whitespace-normal "
                    data-modal-target="timeline-modal-sent-invoice-{{ $columnName->id }}"
                    data-modal-toggle="timeline-modal-sent-invoice-{{ $columnName->id }}"
                    >
                    @php
                        $statusComments = json_decode($columnName->status_comment, true);
                        $firstComment = (is_array($statusComments) && isset($statusComments[0])) ? $statusComments[0] : null;
                ...
                <div id="timeline-modal-sent-invoice-{{ $columnName->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        <!-- Modal content -->
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <!-- Modal header -->
                            <div class="flex items-center justify-between p-2 px-3 rounded-t dark:border-gray-600">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Comments</h3>
                                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm h-8 w-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="timeline-modal-sent-invoice-{{ $columnName->id }}">
                                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                                    </svg>
                                    <span class="sr-only">Close modal</span>
                    ...
                    @if (isset($columnName->statuses[0]))
                        <ul class="py-1 text-[0.6rem] border-2 border-gray-300 text-gray-700 dark:text-gray-200"
                            ...
                            @if((isset($columnName->statuses[0]->status) && $columnName->statuses[0]->status !== 'sent'))
                                @if($teamMembers != null)
                                    <li>
                                        <a href="javascript:void(0);" data-modal-target="edit-modal-sent-invoice"
                                            wire:click="updateVariable('invoice_id', {{ $columnName->id }})"
                                            data-modal-toggle="edit-modal-sent-invoice"
                                            class="block px-4 py-1 hover:bg-orange dark:hover:bg-gray-600 dark:hover:text-white">SFP</a>
                                    </li>
                                @endif
                            @endif
...
@if ($this->persistedTemplate == 'all_invoice')
    ...
    @foreach ($tableTdData as $key => $columnName)
        ...
        @if (isset($columnName->statuses) && count($columnName->statuses) > 0)
            ...
            @if (in_array($latestStatus->status, ['sent', 'draft', 'accept', 'modified', 'reject']))
                <tr
                    class="@if ($key % 2 == 0) bg-[#e9e6e6] dark:bg-gray-800 @endif dark:border-gray-700 dark:bg-gray-800 ">


                    <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300">{{ $i }}</td>
                    <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300">{{ $columnName->invoice_series }}-{{ $columnName->series_num }}
                    <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300"></td>
                    <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300">{{ $columnName->seller }}</td>
                    <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300">{{ date(' h:i A', strtotime($columnName->created_at)) }}</td>
                    <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300">{{ date('j F Y', strtotime($columnName->created_at)) }}</td>
                    ...
                    <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300"> </td>
                    <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300">{{ $columnName->total }}</td>
                    <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300">{{ $columnName->buyer_details->state ?? null }}</td>
                    <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300">
                        @if (isset($columnName->statuses[0]))
                    ...
                    <td>
                        ...
                        <div id="dropdown-{{ $key }}"
                            ...
                            <ul class="py-1 text-[0.6rem] border-2 border-gray-300 text-gray-700 dark:text-gray-200"
                                ...
                                @endif
                                @if ($mainUser->team_user != null)
                                @if ($mainUser->team_user->permissions->permission->buyer->view_invoice == 1)
                                    <li>
                                        @if($isMobile)
                                        @if (isset($columnName->pdf_url))
                                            <a target="_blank"
                ...
                <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300">
                    @if (isset($columnName->statuses[0]))
                        @if ($columnName->statuses[0]->status == 'sent')
                            Pending
                        @else
                            {{ $columnName->statuses[0]->status }}
                        @endif <br>
                        <span
                            class="text-[0.6rem] >{{ date('j F Y, h:i A', strtotime($columnName->statuses[0]->created_at)) }}</span>
                    @endif
                </td>
                <td class="px-2 py-1 text-[0.6rem] border-2 border-gray-300">
                    <button id="dropdownDefaultButton-{{ $key }}"
...
@if ($this->persistedTemplate == 'detailed_purchase_order_buyer')
    {{-- @dd($this->tableTdData) --}}
    @foreach ($this->tableTdData as $key => $columnName)
        {{-- @dd($columnName->purchase_order_series); --}}
        <tr
            class="@if ($key % 2 == 0) border-b bg-[#e9e6e6] dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600 @else bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-600 @endif whitespace-nowrap text-black h-0 w-0">
