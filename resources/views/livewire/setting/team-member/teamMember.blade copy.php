            ...
            <div class="max-w-5xl mt-4 mx-auto">
                {{-- @if ($errorMessage)
                    @foreach (json_decode($this->errorMessage) as $error)
                        <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 15000)" x-show="show" id="success-alert" class="p-4 text-sm text-red-800 mb-1 rounded-lg bg-red-100 dark:bg-gray-800 dark:text-red-400"
                            role="alert">
                ...
                @endif --}}
                @if ($successMessage)
                    <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 15000)" x-show="show" id="success-alert" class="p-4 text-sm text-[#155724] rounded-lg bg-[#d4edda] dark:bg-gray-800 dark:text-green-400"
                        role="alert">
                ...
                <div class="rounded-xl mt-4 border bg-white p-4 border-gray-200 shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    ...
                    <div class="grid gap-6 mb-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p id="phoneError" class="text-red-500 text-xs mt-1 hidden">Phone number should be of 10 digits</p>
                            @error('team_member.phone')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        </div>
                ...
                <div class="mb-4">
                    ...
                    {{-- <div class="relative w-full min-w-[200px] h-10 mt-5">
                        <input class="peer w-full text-black h-full bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 border focus:border-2 focus:border-t-transparent text-sm px-3 py-2.5 rounded-[7px] border-blue-gray-200 focus:border-gray-900"
                            ...
                            wire:model.defer="team_user_name" />
  ...
  <div class="modal-box">
    ...
    <div class="p-4 md:p-5 space-y-4" x-data="{ passwordVisible: false, passwordConfirmVisible: false }">
        <div class="mb-6 relative">
            ...
            <input wire:model="password" :type="passwordVisible ? 'text' : 'password'"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-10 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="•••••••••" required onfocus="this.placeholder = ''" onblur="this.placeholder = '•••••••••'">
            <button type="button" @click="passwordVisible = !passwordVisible" class="absolute inset-y-0 right-0 pr-3 flex items-center py-12 text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none">
                <!-- Eye icon when password is not visible -->
        ...
        <div class="mb-6 relative ">
            ...
            <input :type="passwordConfirmVisible ? 'text' : 'password'" id="confirm_password" wire:model="password_confirmation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-10 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="•••••••••" required onfocus="this.placeholder = ''" onblur="this.placeholder = '•••••••••'">
    ...
    <div class="modal-action">
      <form method="dialog">
        ...
        <button wire:click='changePassword'    class="btn text-white  mr-3 @if($passwordValidated) bg-black  @else bg-gray-200  disabled  @endif hover:bg-orange focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Change Password</button>
