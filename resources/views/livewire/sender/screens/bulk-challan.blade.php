<div class="rounded-lg dark:border-gray-700 mt-4">
    ...
    <div
        ...
        <div id="downloadModal"
            ...
            <div class="bg-white p-6 rounded shadow-lg">
                <h2 class="text-lg font-semibold mb-4">Choose one option to create Bulk Challan</h2>
        ...
        <script>
            ...
            function directDownloadOption(option) {
                ...
                // Change the location
                window.location.href = "{{ url('sender/challan/export-columns') }}/" + option;
            }
        </script>
                    ...
                    <div class="mt-2">
                        ...
                        <div class="relative flex" >
                            <input type="file" wire:model="uploadFile"
                                class="appearance-none block w-full bg-white border border-gray-300 rounded text-xs py-2 md:px-3 leading-tight focus:outline-none focus:border-blue-500">
                            <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                @if($uploadFile)
                                <button class="bg-gray-800 hover:bg-orange text-white hover:text-black py-2 px-3 rounded w-full sm:w-auto"
                                type="submit"
                                wire:loading.attr="disabled">
                            <span wire:loading.remove  wire:target="bulkChallantUpload">Create Bulk Challan</span>
                            <span wire:loading wire:target="bulkChallantUpload">Creating Bulk Challan...</span>
                            </button>
    ...
    <livewire:components.bulk-import-logs  :type="'challan'"/>
