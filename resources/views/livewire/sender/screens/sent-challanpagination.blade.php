<div>
        ...
        <div class="rounded-md pb-2 shadow-sm justify-end flex " role="group">
            ...
            <button type="button" wire:click="innerFeatureRedirect('detailed_sent_challan', null)"
                class="border border-gray-600  px-4 py-1 text-sm  text-black bg-white  focus:z-10 focus:bg-gray-900 focus:text-white focus:ring-2 focus:ring-gray-500 dark:border-white dark:text-white dark:hover:bg-gray-700 dark:hover:text-white dark:focus:bg-gray-700">Detailed
                View</button>
                <div x-data="{ open: false, exportOption: 'current_page' }" class="py-0.5">
                    @if ($mainUser && $mainUser->team_user != null)
                    @if ($mainUser->team_user->permissions->permission->sender->export == 1)

            <a @click="open = true"
                class="rounded-r-lg border border-gray-600  px-4 py-1 pb-1.5 text-sm  text-black bg-white  focus:z-10 focus:bg-gray-900 focus:text-white focus:ring-2 focus:ring-gray-500 dark:border-white dark:text-white dark:hover:bg-gray-700 dark:hover:text-white dark:focus:bg-gray-700">Export</a>
                @endif
                @else
                <a @click="open = true"
        ...
        {{-- Show Select All Options after select any challan or adding filter to select from all pages --}}
        ...
        >
                                        ...
                                        <div id="dropdownDotsHorizontal" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconHorizontalButton">
                                                <li>
                                                    ...
                                                    {{-- <li x-show="showSendOption" class="px-3 py-1 hover:bg-gray-200 cursor-pointer border-b" @click="$wire.set('selectedProducts', selectedProducts); $wire.handleAction('send', 'variableForSend');">
                                                        Send
                                                    </li> --}}
                                                </li>
                                            </ul>
                        ...
                        @if ($challans && count($challans))
                            @foreach ($challans as $key => $columnName)
                                ...
                                <td class="px-2  text-[0.6rem] border-2 border-gray-300 ">
                                    ...
                                    <td class="px-2  text-[0.6rem] border-2 border-gray-300 ">
                                    @if (!is_null($columnName->series_num))
                                            {{ $columnName->challan_series }}-{{ $columnName->series_num }}
                                            @endif
                                    </td>
                                    ...
                                    <td class="px-2  text-[0.6rem] border-2 border-gray-300 ">
                                        @if(!empty($columnName->statuses) && isset($columnName->statuses[0]))
                                            ...
                                            @endphp
                                            {{-- @dump($columnName->challan_date) --}}
                                            @if($columnName->statuses[0]->status != 'draft')
                                                {{ date('j F Y', strtotime($columnName->challan_date)) }}
                                                {{-- <p class="text-[8px]">{{ date('h:i A', strtotime($columnName->challan_date)) }}</p> --}}
                                            @endif
                                        @endif
                                ...
                                <!-- Status Show and open modal -->
                                    ...
                                    " x-data="{ open: false }">
                                        ...
                                        @if(in_array('Tags', $this->ColumnDisplayNames))
                                             <td class="px-2  text-[0.6rem] border-2 border-gray-300" >
                                                {{-- @dd($columnName->tags) --}}
                                        ...
                                        <div id="dropdown-{{ $key }}"
                                            ...
                                            @if(!empty($columnName->statuses) && isset($columnName->statuses[0]))
                                                <ul class=" text-[0.6rem] border-2 border-gray-300 text-gray-700 dark:text-gray-200"
                                                    ...
                                                    @if((isset($columnName->statuses[0]->status) && $columnName->statuses[0]->status !== 'sent' || $columnName->statuses[0]->status == 'draft'))
                                                        @if($teamMembers != null)
                                                            <li>
                                                                <a x-data
                                                                    {{-- x-on:click.prevent="$wire.updateVariable('challan_sfp', {{ $columnName->id }})" --}}
                                                                    wire:click="$emit('openSfpModal', { challanId: {{ $columnName->id ?? 'null' }}, type: 'sent_challan' })"
                                                        ...
                                                        @else
                                                            ...
                                                            @if (!empty($columnName->statuses) && isset($columnName->statuses[0]) && $columnName->statuses[0]->status !== 'draft')
                                                                ...
                                                                @if ($mainUser->team_user != null)
                                                                    @if ($mainUser->team_user->permissions->permission->sender->add_sent_comment == 1)
                                                                    <li>
                                                                        <a x-data
                                                    ...
                                                    @if($columnName->receiver_id)
                                                        @if (!empty($columnName->statuses) && isset($columnName->statuses[0]) && $columnName->statuses[0]->status == 'created')
                                                                @if ($mainUser->team_user != null)
                                                    ...
                                                    @if($columnName->receiver_id )
                                                        ...
                                                        @if($self_delivery)
                                                            @if (!empty($columnName->statuses) && isset($columnName->statuses[0]) && $columnName->statuses[0]->status == 'sent')
                                                                @if ($mainUser->team_user != null)
                                                                    @if ($mainUser->team_user->permissions->permission->sender->accept_return_challan == 1)
                                                                    <li>
                                                    ...
                                                    @if (!empty($columnName->statuses) && isset($columnName->statuses[0]) && ($columnName->statuses[0]->status == 'draft' || $columnName->statuses[0]->status == 'created' || $columnName->statuses[0]->status == 'reject'))
                                                    @if ($mainUser->team_user != null)
                                                    ...
                                                    @endif
                                                    @endif
                                                    @if ($columnName->signature == null && $add_signature )
                                                    @if (!empty($columnName->statuses) && isset($columnName->statuses[0]) && $columnName->statuses[0]->status === 'created')
                                                    <li>
                                                        <a @click="open = true"
                                                    ...
                                                    @if(in_array('Tags', $this->ColumnDisplayNames))
                                                        @if ($mainUser->team_user != null)
                                                            @if ($mainUser->team_user->permissions->permission->sender->add_sent_tags == 1)
                                                            <li>
                                                                <a x-data
                                                    ...
                                                    @endif --}}
                                                    @if ($columnName->statuses[0]->status == 'created' || $columnName->statuses[0]->status == 'reject')
                                                    @if ($mainUser->team_user != null)
                                                    <li>
                                                        <a
                                        ...
                                        <div x-show="open"
                                                ...
                                                <div class="relative p-0.5 w-full max-w-sm max-h-full bg-white rounded-lg shadow dark:bg-gray-700"
                                                    @click.stop>
                                                    <!-- Modal header -->
                                                    <div class="flex items-center justify-between p-2 px-3 rounded-t dark:border-gray-600 border-b">
                                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Add Signature</h3>
                                                        <button type="button"
                                                    ...
                                                    <div class="p-4">
                                                        <div x-data="signaturePad()"
                                                            class="relative rounded-lg mx-auto flex flex-col gap-4">
                                                            <div>
                                                                <canvas x-ref="signature_canvas"
                                                                    class="border rounded shadow bg-gray-300  w-full h-full md:w-auto md:h-auto">
                                                            ...
                                                            <div class="flex">
                                                                <button x-on:click="upload"
                                                                    class="text-white bg-black hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                                                    Save
                                                                </button>
            ...
            <livewire:components.tag-component :panelId="1" :tableId="1" />
            <livewire:components.comment-component :panelId="1" :tableId="1" />
