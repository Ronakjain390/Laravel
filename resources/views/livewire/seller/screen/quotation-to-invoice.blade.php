                    ...
                    <div class="w-full text-gray-900 dark:text-white">
                        ...
                        <div class="grid grid-cols-12 gap-4"  >
                            ...
                            <div class="flex flex-row sm:gap-6">
                                <dt class="mb-1 text-black text-xs dark:text-gray-400 w-24 whitespace-nowrap">Series No
                                </dt>
                            ...
                            <div class="flex flex-row sm:gap-6">
                                <dt class="mb-1 text-black text-xs dark:text-gray-400 w-24">Estimate No</dt>
                                <dd class=" text-xs text-black text-black capitalize">
                                    {{ $estimate_series ?? null }}
                                </dd>
                            </div>
                            <div class="flex flex-row sm:gap-6">
                    ...
                    <div class="col-span-12 md:col-span-6">
                        <div class="grid gap-1">
                            {{-- <div class="flex flex-row items-center">
                                <dt
                                    class="w-24 mb-1 text-black  text-xs dark:text-gray-400 whitespace-nowrap">
                                    Invoice No.
                                </dt>
                                @if ($selectedUser == !null)
...
<div class="bg-[#ebebeb] rounded-lg shadow  overflow-x-auto text-xs">
    ...
    <div class="flex justify-center space-x-4 lg:text-lg text-[0.6rem] sm:text-xs m-2" >
        ...
        {{-- SFP Button --}}
        <button
        wire:click="$emit('openSfpModal', { challanId: {{ $invoiceId ?? 'null' }}, type: 'sent_invoice' })"
