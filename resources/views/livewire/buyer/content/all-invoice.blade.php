<div>
    <div wire:init="loadData">
        ...
        <div class="flex rounded-md pb-2 shadow-sm justify-end" role="group">
            {{-- <button wire:click="innerFeatureRedirect('sent_invoice', null)" type="button" class="rounded-l-lg border border-gray-900 px-4 py-1 text-sm  text-black  focus:z-10 focus:bg-gray-900 focus:text-white focus:ring-2 focus:ring-gray-500 dark:border-white dark:text-white dark:hover:bg-gray-700 dark:hover:text-white dark:focus:bg-gray-700">Export</button> --}}

            <!-- <button  type="button"  class="border border-gray-900 px-4 py-1 text-sm  text-black  focus:z-10 focus:bg-gray-900 focus:text-white focus:ring-2 focus:ring-gray-500 dark:border-white dark:text-white dark:hover:bg-gray-700 dark:hover:text-white dark:focus:bg-gray-700">Detailed View</button> -->

            <button wire:click="innerFeatureRedirect('detailed_all_buyers', null)" type="button" class="rounded-r-lg border border-gray-900 px-4 py-1 text-sm  text-black  focus:z-10 focus:bg-gray-900 focus:text-white focus:ring-2 focus:ring-gray-500 dark:border-white dark:text-white dark:hover:bg-gray-700 dark:hover:text-white dark:focus:bg-gray-700">Detailed View</button>
        </div>
        <div x-data="{
            showSelected: false,
                         ...
                         @if (isset($columnName->statuses) && count($columnName->statuses) > 0)
                            ...
                            <tr ondblclick="window.open('https://docs.google.com/viewer?url={{ urlencode(Storage::disk('s3')->temporaryUrl($columnName->pdf_url, now()->addMinutes(5))) }}', '_blank')"
                                ...
                                <td class="px-1 py-1 whitespace-nowrap">
                                    ...
                                    <td class="px-2  text-[0.6rem] border-2 border-gray-300 whitespace-nowrap">{{ $columnName->buyer }}
                                    ...
                                    <td class="px-2  text-[0.6rem] border-2 border-gray-300 whitespace-nowrap">{{ $columnName->seller }}</td>
                                    ...
                                    <td class="px-2  text-[0.6rem] border-2 border-gray-300 whitespace-nowrap">{{ $columnName->buyer_details->state ?? '' }}</td>
                                        ...
                                        <div id="dropdown-{{ $key }}"
                                            ...
                                            @if (isset($columnName->statuses[0]))
                                                <ul class="py-1 text-[0.6rem] border-2 border-gray-300 text-gray-700 dark:text-gray-200"
                                                    ...
                                                    <li>
                                                        <a x-data
                                                            wire:click="$emit('openSfpModal', { challanId: {{ $columnName->id ?? 'null' }}, type: 'all_invoice' })"
                                                ...
                                                @endif
                                                    @if ($mainUser->team_user != null)
                                                            ...
                                                            @endphp
                                                                ...
                                                                {{-- @if (in_array($latestStatus->status, ['sent', 'draft', 'accept', 'modified', 'reject'])) --}}
                                                                    ...
                                                                    @if ($mainUser && $mainUser->team_user != null)
                                                                        ...
                                                                        <li>
                                                                            <a x-data
                                                                            wire:click="$emit('openCommentModal',{{ $columnName->id }}, 'accept')"
                                                                            class="block px-4 py-1 hover:bg-orange dark:hover:bg-gray-600 dark:hover:text-white cursor-pointer">
                                                                                Accept
                                                                            </a>
                                                                        </li>
                                                                    ...
                                                                    @if ($mainUser && $mainUser->team_user != null)
                                                                        ...
                                                                        <li>
                                                                            <a x-data
                                                                            wire:click="$emit('openCommentModal',{{ $columnName->id }}, 'reject')"
                                                                            class="block px-4 py-1 hover:bg-orange dark:hover:bg-gray-600 dark:hover:text-white cursor-pointer">
                                                                                Reject
                                                                            </a>
                                                                        </li>
                                                            ...
                                                            @if ($mainUser->team_user != null)
                                                            @if ($mainUser->team_user->permissions->permission->buyer->add_invoice_comment == 1)
                                                            <li>
                                                                <a x-data
                                                    ...
                                                    @if ($mainUser->team_user != null)
                                                        @if ($mainUser->team_user->permissions->permission->buyer->add_invoice_tags == 1)
                                                        <li>
                                                            <a x-data
        ...
        @endif
        <livewire:components.sfp-component :panelType="'all_invoice'"/>
        <livewire:components.tag-component :panelId="4" :tableId="8" />
        <livewire:components.comment-component :panelId="4" :tableId="8" />
        @endif
    </div>
    <script>
