...
<head>
    <meta charset="UTF-8">
    <title>Accept Return Challan PDF Email</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <p> Hello, <strong>{{ucfirst($returnChallan->receiver)}}</strong> your sent Return Challan has been accepted by  <strong> {{ ucfirst($returnChallan->sender)}} </strong></p>
        ...
        <table style="width: 100%; margin-top:12px;" class="table-data">
            <thead>
                ...
                <tr>
                    <td>
                        <b>Status:</b>
                        <p>{{ $returnChallan->status ?? 'Accepted'}}</p>
                    </td>
                </tr>
                <tr class="total">
                    <td colspan="2">
