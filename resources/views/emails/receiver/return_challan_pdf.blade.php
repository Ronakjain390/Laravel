                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 10px 15px;font-family:'Montserrat',sans-serif;" align="center">
                                                            <div class="v-text-align" style="font-size: 12px; color: #34495e; line-height: 150%; text-align: left; word-wrap: break-word;">
                                                                ...
                                                                <p> Hello,
                                                                    <strong>{{ucfirst($returnChallan->receiver)}}</strong>
                                                                    you have received a new Return Challan from
                                                                    <strong> {{
                                                                        ucfirst($returnChallan->receiverUser->company_name
                                                                        ?? $returnChallan->receiverUser->name)}}
                                                                    </strong></p>
    ...
    <div class="u-row-container" style="padding: 0px;background-color: transparent">
      ...
      <table id="u_content_text_4" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="font-size: 12px; color: #ffffff; line-height: 140%; text-align: right; word-wrap: break-word;">
          <p style="font-size: 12px; line-height: 140%;"><span style="font-size: 14px; line-height: 22.4px; font-family: Montserrat, sans-serif;">@if (isset($returnChallan->receiverUser->phone))  {{ $returnChallan->receiverUser->phone }}   @endif
        <br>
        @if (isset($returnChallan->receiverUser->address))   {{
            ucfirst($returnChallan->receiverUser->address) }}  @endif
            <br>
        @if (isset($returnChallan->receiverUser->city))  {{ ucfirst($returnChallan->receiverUser->city) }} @endif, @if (isset($returnChallan->receiverUser->state))  {{ ucfirst($returnChallan->receiverUser->state) }}  @endif, @if (isset($returnChallan->receiverUser->pincode))  {{ ucfirst($returnChallan->receiverUser->pincode) }} @endif
      ...
      <table id="u_content_text_7" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <p style="font-size: 0px; line-height: 140%; color: white;">
            <span style="font-size: 14px; line-height: 22.4px; font-family: Montserrat, sans-serif;">
                @if (isset($returnChallan->receiverUser->email)) 
                    {{ ucfirst($returnChallan->receiverUser->email) }} <br> 
                @endif
            </span>
        </p>
        </div>
      ...
      <table id="u_content_text_6" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="font-size: 12px; color: #ffffff; line-height: 140%; text-align: right; word-wrap: break-word;">
          <p style="font-size: 0px; line-height: 140%;"><span style="font-size: 14px; line-height: 22.4px; font-family: Montserrat, sans-serif;"> {{ ucfirst($returnChallan->receiverUser->company_name ?? $returnChallan->receiverUser->name) }} </span></p>
        </div>
...
<div class="u-row-container" style="padding: 0px;background-color: transparent">
  ...
  <table id="u_content_text_13" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="font-size: 12px; line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 0px; line-height: 140%;"><span style="font-size: 12px; line-height: 22.4px;">
        @if (isset($returnChallan->senderUser->name)) {{ ucfirst($returnChallan->senderUser->name) }} @endif,@if (isset($returnChallan->senderUser->address))  {{ ucfirst($returnChallan->senderUser->address) }}  @endif,
        @if (isset($returnChallan->senderUser->city))  {{ ucfirst($returnChallan->senderUser->city) }} @endif, @if (isset($returnChallan->senderUser->state))  {{ ucfirst($returnChallan->senderUser->state) }}  @endif, @if (isset($returnChallan->senderUser->pincode))  {{ ucfirst($returnChallan->senderUser->pincode) }} @endif
    </span></p>
    </div>
  ...
  <table id="u_content_text_18" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="font-size: 12px;  line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 12px; line-height: 140%;"><span style="font-size: 12px; line-height: 16.8px;"><strong><span style="line-height: 19.6px; font-size: 14px;">Challan Number :{{ strtoupper($returnChallan->challan_series) }}-{{ $returnChallan->series_num }}</span></strong></span></p>
    </div>
  ...
  <table id="u_content_text_15" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="font-size: 12px;  line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 12px; line-height: 140%;"><strong><span style="font-size: 14px; line-height: 22.4px;">Date Of Issue :{{ date('d-m-Y', strtotime($returnChallan->challan_date)) }}</span></strong></p>
    </div>
...
<div class="u-row-container" style="padding: 0px;background-color: transparent">
    ...
    <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;"><!--<![endif]-->
        ...
        <table id="u_content_text_69" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
            ...
            <div class="v-text-align" style="font-size: 14px; color: #ffffff; line-height: 140%; text-align: right; word-wrap: break-word;">
              <p style="font-size: 14px; line-height: 140%; float: left;"><span style="font-size: 18px; line-height: 25.2px;">  <a style="background-color: white; border: 1px solid black; color: black; text-decoration: none; padding:6px; border-radius:10px; font-size: small;" href="{{url('accept-challan/'. $returnChallan->id)}}"> Accept / Reject this Challan </a></span></p>
            </div>
  ...
  <table id="u_content_text_69" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="font-size: 14px; color: #ffffff; line-height: 140%; text-align: right; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px;"><strong> Total:  &#8377; {{ $returnChallan->total }}</strong></span></p>
    </div>
