...
<head>
    ...
    <title>Purchase Order PDF Email</title>
    <style type="text/css">
                    ...
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row" style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #d9eef8;">
                            <div style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                                ...
                                <!--[if (mso)|(IE)]><td align="center" width="50" style="width: 50px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 1px solid #fff;border-bottom: 0px solid transparent;" valign="top"><![endif]-->
                                <div class="u-col u-col-8" style="max-width: 50px;min-width: 80px;display: table-cell;vertical-align: top;">
                                    <p style="font-family: Lato, sans-serif; font-size: 0px; "><span style="font-size: 14px; line-height: 24px;">&nbsp;
                                    <div style="height: 65px;width: 100% !important; display: flex; justify-content: center; margin: 8px 0px 0 px 22px !important;">
                                        <img align="center" border="0" src="{{asset('image/Vector.png')}}" alt="Logo" title="Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: 50px;width: 100%;max-width: 70px;" />
                                    </div>
                                </div>
                                <!--[if (mso)|(IE)]></td><![endif]-->

                                <!--[if (mso)|(IE)]><td align="center" width="548" style="width: 548px;padding: 0px;border-top: 0px solid transparent;border-left: 1px solid #fff;border-right: 1px solid #fff;border-bottom: 0px solid transparent;" valign="top"><![endif]-->
                                <div class="u-col u-col-92" style="max-width: 548px;min-width: 515px;display: table-cell;vertical-align: top;">
                                    <div style="height: 100%;width: 100% !important;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 1px solid #fff;border-right: 1px solid #fff;border-bottom: 0px solid transparent;">
                                            <!--<![endif]-->
                                            ...
                                            <table id="u_content_text_88" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 10px 15px;font-family:'Montserrat',sans-serif;" align="center">
                                                            <div class="v-text-align" style="font-size: 12px; color: #34495e; line-height: 150%; text-align: left; word-wrap: break-word;">

                                                                <p> Hello,
                                                                    <strong>{{ucfirst($purchaseOrder->buyer_name)}}</strong>
                                                                    you have received a new Return Challan from
                                                                    <strong> {{
                                                                        ucfirst($purchaseOrder->buyerUser->company_name
                                                                        ?? $purchaseOrder->buyerUser->name)}}
                                                                    </strong></p>
                                                                <p>Login to your <a href="https://theparchi.com/">TheParchi.com</a> account to check more details.</p>
                                                                <p> Still not using TheParchi ? <a href="https://theparchi.com/">Get your free account today.</a></p>
                                                                </p>
                                                            </div>
                                                        </td>
                                                    </tr>
    ...
    <div class="u-row-container" style="padding: 0px;background-color: transparent">
      ...
      <table id="u_content_heading_2" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <!--[if mso]><table width="100%"><tr><td><![endif]-->
          <h1 class="v-text-align" style="margin: 0px; color: #ffffff; line-height: 140%;  word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 22px; font-weight: 400;"><strong>CHALLAN</strong></h1>
      ...
      <table id="u_content_text_4" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="font-size: 12px; color: #ffffff; line-height: 140%; text-align: right; word-wrap: break-word;">
          <p style="font-size: 12px; line-height: 140%;"><span style="font-size: 14px; line-height: 22.4px; font-family: Montserrat, sans-serif;">@if (isset($purchaseOrder->buyerUser->phone))  {{ $purchaseOrder->buyerUser->phone }}   @endif
        <br>
        @if (isset($purchaseOrder->buyerUser->address))   {{
            ucfirst($purchaseOrder->buyerUser->address) }}  @endif
            <br>
        @if (isset($purchaseOrder->buyerUser->city))  {{ ucfirst($purchaseOrder->buyerUser->city) }} @endif, @if (isset($purchaseOrder->buyerUser->state))  {{ ucfirst($purchaseOrder->buyerUser->state) }}  @endif, @if (isset($purchaseOrder->buyerUser->pincode))  {{ ucfirst($purchaseOrder->buyerUser->pincode) }} @endif
      ...
      <table id="u_content_text_7" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="font-size: 12px; color: #ffffff; line-height: 140%; text-align: right; word-wrap: break-word;">
        <p style="font-size: 0px; line-height: 140%; color: white;">
            <span style="font-size: 14px; line-height: 22.4px; font-family: Montserrat, sans-serif;">
                @if (isset($purchaseOrder->buyerUser->email))
                    {{ ucfirst($purchaseOrder->buyerUser->email) }} <br>
                @endif
            </span>
        </p>
        </div>
      ...
      <table id="u_content_text_6" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        <tbody>
          <tr>
            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 30px 0px 10px;font-family:'Montserrat',sans-serif;" align="left">

        <div class="v-text-align" style="font-size: 12px; color: #ffffff; line-height: 140%; text-align: right; word-wrap: break-word;">
          <p style="font-size: 0px; line-height: 140%;"><span style="font-size: 14px; line-height: 22.4px; font-family: Montserrat, sans-serif;"> {{ ucfirst($purchaseOrder->buyerUser->company_name ?? $purchaseOrder->buyerUser->name) }} </span></p>
        </div>
      ...
      <table id="u_content_text_5" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="font-size: 12px; color: #ffffff; line-height: 140%; text-align: right; word-wrap: break-word;">
          <p style="font-size: 12px; line-height: 140%;"><span style="font-size: 14px; line-height: 22.4px; font-family: Montserrat, sans-serif;">San Francisco, CA. United States </span></p>
        </div>
...
<div class="u-row-container" style="padding: 0px;background-color: transparent">
  ...
  <table id="u_content_text_14" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    <tbody>
      <tr>
        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:5px 2px 0px 15px;font-family:'Montserrat',sans-serif;" align="left">

    <div class="v-text-align" style="font-size: 14px;  line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style=" line-height: 140%;"><strong><span style="font-size: 14px; line-height: 22.4px;">Ship To </span></strong></p>
    </div>
  ...
  <table id="u_content_text_13" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    <tbody>
      <tr>
        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 4px 15px;font-family:'Montserrat',sans-serif;" align="left">

    <div class="v-text-align" style="font-size: 12px; line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 0px; line-height: 140%;"><span style="font-size: 12px; line-height: 22.4px;">
        @if (isset($purchaseOrder->sellerUser->name)) {{ ucfirst($purchaseOrder->sellerUser->name) }} @endif,@if (isset($purchaseOrder->sellerUser->address))  {{ ucfirst($purchaseOrder->sellerUser->address) }}  @endif,
        @if (isset($purchaseOrder->sellerUser->city))  {{ ucfirst($purchaseOrder->sellerUser->city) }} @endif, @if (isset($purchaseOrder->sellerUser->state))  {{ ucfirst($purchaseOrder->sellerUser->state) }}  @endif, @if (isset($purchaseOrder->sellerUser->pincode))  {{ ucfirst($purchaseOrder->sellerUser->pincode) }} @endif
    </span></p>
    </div>
  ...
  <table id="u_content_text_18" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    <tbody>
      <tr>
        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:4px 0px 0px 15px;font-family:'Montserrat',sans-serif;" align="left">

    <div class="v-text-align" style="font-size: 12px;  line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 12px; line-height: 140%;"><span style="font-size: 12px; line-height: 16.8px;"><strong><span style="line-height: 19.6px; font-size: 14px;">Challan Number :{{ strtoupper($purchaseOrder->purchase_order_series) }}-{{ $purchaseOrder->series_num }}</span></strong></span></p>
    </div>
  ...
  <table id="u_content_text_15" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    <tbody>
      <tr>
        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 0px 0px 15px;font-family:'Montserrat',sans-serif;" align="left">

    <div class="v-text-align" style="font-size: 12px;  line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 12px; line-height: 140%;"><strong><span style="font-size: 14px; line-height: 22.4px;">Date Of Issue :{{ date('d-m-Y', strtotime($purchaseOrder->created_at)) }}</span></strong></p>
    </div>
  ...
  <table id="u_content_text_12" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="font-size: 12px;  line-height: 140%; text-align: right; word-wrap: break-word;">
      <p style="font-size: 12px; line-height: 140%;"><strong><span style="font-size: 14px; line-height: 22.4px;">Invoice Total</span></strong></p>
    </div>
  ...
  <table id="u_content_text_17" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="font-size: 12px; line-height: 140%; text-align: right; word-wrap: break-word;">
      <p style="font-size: 12px; line-height: 140%;"><span style="color: #34495e; font-size: 12px; line-height: 19.6px;"><strong><span style="font-size: 20px; line-height: 28px;">₹  4321.00 </span></strong></span></p>
    </div>
...
<div class="u-row-container" style="padding: 0px;background-color: transparent">
  ...
  <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    <tbody>
      <tr>
        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 0px 0px;font-family:'Montserrat',sans-serif;" align="left">

    <table height="0px" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;border-top: 3px dashed #34495e;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
      <tbody>
        <tr style="vertical-align: top">
  ...
  <!--[if (mso)|(IE)]></td><![endif]-->
    ...
    <div class="u-row-container" style="padding: 0px;background-color: transparent">
      ...
      <!--[if (mso)|(IE)]><td align="center" width="169" style="width: 169px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;" valign="top"><![endif]-->
        ...
        <div class="u-col u-col-20p83" style="max-width: 40px;min-width: 20px;display: table-cell;vertical-align: top;">
            <div style="height: 100%;width: 100% !important;">
            <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;"><!--<![endif]-->
          ...
          <table id="u_content_text_22" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
            ...
            <div class="v-text-align" style="font-size: 12px; color: #34495e; line-height: 140%; text-align: left; word-wrap: break-word;">
              <p style="font-size: 12px; line-height: 140%;"><span style="font-size: 14px; line-height: 22.4px;"><strong># </strong></span></p>
            </div>
      ...
      <table id="u_content_text_21" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="font-size: 12px; color: #34495e; line-height: 140%; text-align: left; word-wrap: break-word;">
          <p style="font-size: 12px; line-height: 140%;"><span style="font-size: 14px; line-height: 22.4px;"><strong>Description </strong></span></p>
        </div>
      ...
      <table id="u_content_text_22" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="font-size: 12px; color: #34495e; line-height: 140%; text-align: left; word-wrap: break-word;">
          <p style="font-size: 12px; line-height: 140%;"><span style="font-size: 14px; line-height: 22.4px;"><strong>Rate </strong></span></p>
        </div>
      ...
      <div class="u-col u-col-23p83" style="max-width: 320px;min-width: 90px;display: table-cell;vertical-align: top;">
        <div style="height: 100%;width: 100% !important;">
        <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;"><!--<![endif]-->
      ...
      <table id="u_content_text_23" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="font-size: 12px; color: #34495e; line-height: 140%; text-align: left; word-wrap: break-word;">
          <p style="font-size: 12px; line-height: 140%;"><span style="font-size: 14px; line-height: 22.4px;"><strong>Qty </strong></span></p>
        </div>
      ...
      <table id="u_content_text_20" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="font-size: 12px; color: #34495e; line-height: 140%; text-align: right; word-wrap: break-word;">
          <p style="font-size: 12px; line-height: 140%;"><span style="font-size: 14px; line-height: 22.4px;"><strong>Amount</strong></span></p>
        </div>
      ...
      <!--[if (mso)|(IE)]></td><![endif]-->
        ...
        @php
                    // dd($purchaseOrder->orderDetails);
                    $total_rate = 0;
                @endphp
                @foreach ($purchaseOrder->orderDetails as $index => $detail)
      ...
      <!--[if (mso)|(IE)]><td align="center" width="179" style="width: 179px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;" valign="top"><![endif]-->
        <div class="u-col u-col-22p66" style="max-width: 320px;min-width: 20px;display: table-cell;vertical-align: top;">
            <div style="height: 100%;width: 100% !important;">
            <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;"><!--<![endif]-->
          ...
          <table id="u_content_text_74" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
            <tbody>
              <tr>
                <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 9px;font-family:'Montserrat',sans-serif;" align="left">

            <div class="v-text-align" style="font-size: 12px; color: #34495e; line-height: 140%; text-align: left; word-wrap: break-word;">
              <p style="font-size: 12px; line-height: 140%;"><strong>  {{ $index + 1 }}</strong></p>
            </div>
      ...
      <table id="u_content_text_72" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="font-size: 12px; color: #34495e; line-height: 140%; text-align: left; word-wrap: break-word;">
          <p style="font-size: 12px; line-height: 140%;"><strong>@if ($detail->columns[0]->column_value)
            <p style="font-size: 12px; line-height: 140%;">
                <strong>{{ strtoupper($detail->columns[0]->column_value) }}</strong>
            </p>
        @endif </strong></p>
        </div>
      ...
      <table id="u_content_text_73" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        <tbody>
          <tr>
            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 3px 0px 15px;font-family:'Montserrat',sans-serif;" align="left">

        <div class="v-text-align" style="font-size: 12px; color: #34495e; line-height: 140%; text-align: left; word-wrap: break-word;">
          <p style="font-size: 12px; line-height: 140%;">@if ($detail->columns[2]->column_value)
            <p style="font-size: 12px; line-height: 140%;">
                {{ strtoupper($detail->columns[2]->column_value) }}
            </p>
        @endif</p>
        </div>
      ...
      <table id="u_content_text_74" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="font-size: 12px; color: #34495e; line-height: 140%; text-align: left; word-wrap: break-word;">
          <p style="font-size: 12px; line-height: 140%;"><strong> {{ $detail->rate }}</strong></p>
        </div>
      ...
      <div class="u-col u-col-21p33" style="max-width: 320px;min-width: 90px;display: table-cell;vertical-align: top;">
        <div style="height: 100%;width: 100% !important;">
        <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;"><!--<![endif]-->
      ...
      <table id="u_content_text_75" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="font-size: 12px; color: #34495e; line-height: 140%; text-align: left; word-wrap: break-word;">
          <p style="font-size: 12px; line-height: 140%;"><strong>{{ $detail->qty }}</strong></p>
        </div>
      ...
      <table id="u_content_text_76" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        <tbody>
          <tr>
            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 15px 10px 10px;font-family:'Montserrat',sans-serif;" align="left">

        <div class="v-text-align" style="font-size: 12px; color: #34495e; line-height: 140%; text-align: right; word-wrap: break-word;">
          <p style="font-size: 12px; line-height: 140%;"><strong>{{ $detail->total_amount }}</strong></p>
        </div>
    ...
    <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;"><!--<![endif]-->
        ...
        <table id="u_content_text_69" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
            ...
            <div class="v-text-align" style="font-size: 14px; color: #ffffff; line-height: 140%; text-align: right; word-wrap: break-word;">
              <p style="font-size: 14px; line-height: 140%; float: left;"><span style="font-size: 18px; line-height: 25.2px;">  <a style="background-color: white; border: 1px solid black; color: black; text-decoration: none; padding:6px; border-radius:10px; font-size: small;"
                href="{{ route('accept.document', ['type' => 'purchase_order', 'documentId' => $purchaseOrder->id]) }}"> Accept / Reject this Purchase Order  </a></span></p>
            </div>
  ...
  <table id="u_content_text_69" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="font-size: 14px; color: #ffffff; line-height: 140%; text-align: right; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px;"><strong> Total:  &#8377; {{ $purchaseOrder->total }}</strong></span></p>
    </div>
...
<div class="u-row-container" style="padding: 0px;background-color: transparent">
    ...
    <div style="display: table; max-width:167px;">
      ...
      <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 10px">
        <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
          <a href="https://twitter.com/theparchi_?s=11" title="Twitter" target="_blank">
      ...
      <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 0px">
        <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
          <a href="https://vimeo.com/" title="Vimeo" target="_blank">
            <img src="images/image-3.png" alt="Vimeo" title="Vimeo" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
          </a>
        </td></tr>
      </tbody></table>
  ...
  <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="font-size: 12px; color: #ffffff; line-height: 150%; text-align: center; word-wrap: break-word;">
      <p style="font-size: 12px; line-height: 150%;">If you have any questions, feel free message us at <span style="color: #ffffff; font-size: 12px; line-height: 21px;"><a style="color: #ffffff;" href="mailto:contact@theparchi.com" target="_blank" rel="noopener">contact@theparchi.com</a>.</span></p>
  <p style="font-size: 12px; line-height: 150%;">All right reserved.<br /> <small>POWERED BY</small> <a href="https://theparchi.com/" style="color: white; margin-top:5px;">www.TheParchi.com</a></p>
  <!-- <p style="font-size: 12px; line-height: 150%;"><br /> <br /><a href="{{ route('page', ['slug' => 'terms-and-conditions']) }}"
    class="small sender-and-buyer_name-text a-active">Terms & Conditions </a>
    | <a href="{{ route('page', ['slug' => 'privacy-policy']) }}" class="small sender-and-buyer_name-text">Privacy Policy </a>|
        <a href="{{ route('page', ['slug' => 'cancellation-policy']) }}"
        class="small sender-and-buyer_name-text">Cancellation Policy</a>
    </a></p> -->
