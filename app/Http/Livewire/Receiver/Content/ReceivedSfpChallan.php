...
class ReceivedSfpChallan extends Component
{
    use WithPagination;
    ...
    public function render()
    {
            ...
            $challans = $query
                ...
                ->whereExists(function ($query) {
                    $query->select(DB::raw(1))
                        ...
                        ->whereIn('challan_statuses.status', ['sent', 'accepted'])
        ...
        return view('livewire.receiver.content.received-sfp-challan', compact('challans' ))->with(['distinctChallanSeries' =>  $distinctChallanSeries,
